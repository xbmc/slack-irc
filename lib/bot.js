...
Bot.prototype.parseMessage = function(message) {
  return message
    ...
    // bold
    .replace(/(\u0002)([^\u0002]+)(\u0002|\u000f|$)/g, function(match, opener, formattedText, end) {
    ...
    // remove colour
    .replace(/(\u0003[0-9]{0,2},?[0-9]{0,2})([^\u0003]+)(\u0003|\u000f|$)/g, function(match, opener, formattedText, end) {
      return formattedText;
    });
};
...
Bot.prototype.sendToIRC = function(message) {
  ...
  if (ircChannel) {
    ...
    if (this.isCommandMessage(text)) {
      ...
      text = String.fromCharCode(02) + '<' + user.name + '>: ' + String.fromCharCode(02) + text;
